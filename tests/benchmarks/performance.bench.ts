 ...
 */
export async function benchmarkMatchDiscovery(): Promise<BenchmarkResult> {
 ...
 */
export async function benchmarkMessageDelivery(): Promise<BenchmarkResult> {
  const startTime = performance.now();
 ...
 */
export async function benchmarkBundleSize(): Promise<BenchmarkResult> {
  try {
 ...
 */
export function benchmarkMemoryUsage(): BenchmarkResult {
 ...
 */
export function getBenchmarkHistory(): Array<{ timestamp: number; results: BenchmarkResult[] }> {
  const key = 'isc-benchmarks-history';
