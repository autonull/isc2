...
import { Validators, isDefined, isNonEmptyArray, isValidNumber, assert, requireValue, } from '../src/validators.js';
...
describe('Validators', () => {
    ...
    describe('Validators.keypair', () => {
        ...
        it('should throw for missing publicKey', () => {
            ...
            expect(() => Validators.keypair(keypair)).toThrow();
        });
...
describe('Error Handling', () => {
    ...
    describe('withErrorHandling', () => {
        it('should handle errors in async function', async () => {
            ...
            }, ErrorCodes.NETWORK_ERROR, 'Operation failed');
            await expect(fn()).rejects.toThrow('Operation failed');
        });
        it('should return result for successful function', async () => {
            const fn = withErrorHandling(async () => 42, ErrorCodes.NETWORK_ERROR, 'Operation failed');
