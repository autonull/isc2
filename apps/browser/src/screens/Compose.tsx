...
export function ComposeScreen() {
  ...
  return (
    <div style={styles.screen}>
      <header style={styles.header}>
        ...
        <button
          style={{
            ...styles.button,
            ...styles.saveBtn,
            opacity: saving || modelStatus === 'loading' ? 0.5 : 1,
          }}
          onClick={handleSave}
          disabled={saving || modelStatus === 'loading'}
        >
          {modelStatus === 'loading'
            ? `Loading ${Math.round(modelProgress * 100)}%...`
            : saving
              ? 'Saving...'
              : 'Save'}
        </button>
      ...
      {modelStatus === 'ready' && (
        <div
          style={{ padding: '8px 16px', background: '#d4edda', borderBottom: '1px solid #c3e6cb' }}
        >
              ...
              <div key={opt.value}>
                ...
                {isEditing && (
                  <div style={styles.relationInput}>
                    ...
                    />
                    <button style={styles.saveBtn as any} onClick={handleSaveRelation}>
                      Add
                    </button>
                    <button
