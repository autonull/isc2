...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@isc/core/crypto': resolve(__dirname, '../../packages/core/src/crypto/index.ts'),
      '@isc/core/math': resolve(__dirname, '../../packages/core/src/math/index.ts'),
      '@isc/core/math/lsh': resolve(__dirname, '../../packages/core/src/math/lsh.ts'),
      '@isc/core/encoding': resolve(__dirname, '../../packages/core/src/encoding.ts'),
